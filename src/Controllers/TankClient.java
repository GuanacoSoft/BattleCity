 ...
 */
	...
	public void framPaint(Graphics g) {
		...
		if(!Player2)g.drawString("Tanks Remaining: ", 200, 70);
		else g.drawString("Tanks Remaining: ", 100, 70);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand().equals("NewGame")) {
			...
			printable = false;
			JOptionPane.showMessageDialog(null, " Battel City v1.1.0 \n \n Game For One Player and Two Player  \n Version : [ 1.1.0 ] \n Developed By [ Jignesh Chudasama ]   \n \n      Enjoy The GAME !!",
